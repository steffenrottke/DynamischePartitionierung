...
function insertBestFit(){
    ...
    groesseEins[$kleinsteDifferenzStelle]=$(($seekGroesse)) #Größe an der Stelle im Array einfügen
    nameEins[$kleinsteDifferenzStelle]=$seekName #Name an der Stelle im Array einfügen
    counter=0
