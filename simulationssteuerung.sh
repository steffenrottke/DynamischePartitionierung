...
#Funktion fuer die Steuerung des Simulators bei der Eingabe von c, d oder n
simulationssteuerung () {
	...
	"d")
		...
		;;
	#Wenn der Befehl new gewaehlt wurde, wird nun ausgegeben, dass die Speicherbelegung zurueckgesetzt wurde
        "n")
		...
		;;
	#Wenn keiner der drei vorherigen Befehle eingegeben wurde, wird eine Fehlermeldung ausgegeben
        *)
